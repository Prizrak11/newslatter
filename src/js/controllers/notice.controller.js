...
export const Notice = (content) => {
  ...
  createCard(document, '.main-content__notice', data[random(data.length, data.length - 1)])
  createCard(document, '.main-content__notice', data[random(data.length, data.length - 2)])
  createCard(document, '.main-content__notice', data[random(data.length, data.length - 3)])
}